...
// This one is easy
state = READY;
System.out.println("The RTSP state is now READY");
...
//like before...
state = PLAYING;
System.out.println("The RTSP state is now PLAYING");
...
state = INIT;
System.out.println("The RTSP state is now INIT");
...
// this stuff is sticky with the spacing
...
if(state == INIT){
	...
	// I just beat my head on this for a long time, because spacing matters
}else{
