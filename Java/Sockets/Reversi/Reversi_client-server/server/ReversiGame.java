// Will MacLean
//
// I tried not to modify this too much from the stand-alone...
// But found I had to change it a bit.
...
public class ReversiGame {
	...
	public void changeAnXYCoordinate(int x, int y, String currentPlayer){
		...
		System.out.println("in changeAnXYCoordinate(int x, int y, String currentPlayer)");
	} 
	...
	public String toString(String[][] reversiBoard){
	...
	public int getCoordinate(String currentPlayer, String coordinate){
		System.out.println("in getCoordinate(String currentPlayer, String coordinate)");
		int aNumber = 0;
		String input;
	...
	public boolean checkingTheSpot(int xLoc, int yLoc){
		boolean goodMove = false;
		System.out.println("in checkingTheSpot()");
		System.out.println("in checkingTheSpot() while");
		String whatIsThere = this.getTheCoordinate(
				this.getX(), 
				this.getY());
		if(whatIsThere.equals("X") || whatIsThere.equals("O")){
			System.out.println("in what is there");
			goodMove = false;
			//System.out.println("That spot is taken - try again.");
		}else{
			if (this.checkingForNeighbors(
					this.getX(), 
					this.getY()) 
					== true){
				goodMove = true;
				this.changeAnXYCoordinate(
						this.getX(), 
						this.getY(), 
				...
				// print board
				System.out.println(this.toString(this.getReversiBoard()));
	...
	public static void main(String[] args) {
		...
		while(aReversiGame.getGameOver() == false) {
			//display the board
			System.out.println(aReversiGame.toString(aReversiGame.getReversiBoard()));
