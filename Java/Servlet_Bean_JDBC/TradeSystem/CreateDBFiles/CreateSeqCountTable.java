...
public class CreateSeqCountTable{
	...
	try{
	    stmt.executeUpdate( "DROP TABLE SeqCount" );
	    System.out.println("Table SeqCount was removed.");
	}catch ( Exception e ) { /* don't care */ }

	// execute SQL commands 
	// to create table and insert data
	try{
	    String update = "CREATE TABLE SeqCount (" + 
				"SeqCountKey INTEGER NOT NULL PRIMARY KEY, " +
				"SeqCountNum FLOAT NOT NULL" +
				")";

	    System.out.println(update);
	    stmt.executeUpdate(update);

	    System.out.println("Table SeqCount was created.");

	    // initialize Volume
	   stmt.executeUpdate("INSERT INTO SeqCount VALUES(1, 5)");
