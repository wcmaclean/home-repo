 ...
 *
 * This is a sell that's persistent.  It has an SellID #, a name,
 * a description, and a base price.
 */

public abstract class SellBean implements EntityBean {
	...
	public abstract void setSellID(String sellID);

	public abstract long getClientID();
	public abstract void setClientID(long aClientID);	

	public abstract long getClSeqID();
	public abstract void setClSeqID(long aClSeqID);

	public abstract int getQuantity();
	public abstract void setQuantity(int aQuantity);

	public abstract int getPrice();
	public abstract void setPrice(int aPrice);

	public abstract long getClTime();
	public abstract void setClTime(long aClTime);
	 ...
	 * argument.
	 */
	public void ejbPostCreate(String sellID, long aClientID, long aClSeqID, int aQuantity, int aPrice, long aClTime) {
	 ...
	 * entries.
	 */
	public String ejbCreate(String sellID, long aClientID, long aClSeqID, int aQuantity, int aPrice, long aClTime) {
