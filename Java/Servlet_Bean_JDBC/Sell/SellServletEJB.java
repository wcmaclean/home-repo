...
public class SellServletEJB extends HttpServlet {
	...
	try {
	    ...
	    Object obj = ctx.lookup("SellHome");
	    SellHome home = 
		(SellHome)javax.rmi.PortableRemoteObject.narrow(obj, 
			SellHome.class);
	    Sell aSell = home.create();
