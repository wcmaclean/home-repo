...
# which is impossible in Ruby. So instead, I am doing the long-hand
# version of accessors and mutators, leaving the shorthand version
# for stocksacc.rb 
...
read_port = My_Reader.new("dowportfolio.csv")
