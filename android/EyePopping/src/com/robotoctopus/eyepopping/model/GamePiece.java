...
public class GamePiece {
	...
	private int angle = 3;
	private String splat = "not splatted";
	...
	*/
	...
	public void reset(){
		...
		reset = false;
		newVelo = rnd.getRandIntBetween(1, 2);
		//newVelo = 10;
		veloX = newVelo;
		veloY = newVelo;
	...
	public void growXY(){
		...
		if(reset==true){ 
			angle = RandomNumberGenerator.getRandIntBetween(1, 4);
			reset = false;
			newVelo = RandomNumberGenerator.getRandIntBetween(1, 3);
			veloX = newVelo;
			veloY = newVelo;
		}
	}
