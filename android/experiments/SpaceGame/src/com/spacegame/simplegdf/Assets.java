...
import com.spacegame.framework.animation.Animation;
import com.spacegame.framework.animation.Frame;
...
public class Assets {
	...
	public static void load(){
		...
		ufo1=loadBitmap("ufo1.png", false);
		ufo2=loadBitmap("ufo2.png", false);
		...
		ufoAnimation = new Animation(ufof1, ufof2, ufof3, ufof4);
		
		spaceship1=loadBitmap("spaceship1.png", false);
		spaceship2=loadBitmap("spaceship2.png", false);
		...
		spaceshipAnimation = new Animation(spaceshipf1, spaceshipf2, spaceshipf3, 
				spaceshipf4, spaceshipf5, spaceshipf4, spaceshipf3, spaceshipf2);
