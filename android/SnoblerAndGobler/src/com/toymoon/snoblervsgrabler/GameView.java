...
import com.toymoon.snoblervsgrabler.framework.util.InputHandler;
import com.toymoon.snoblervsgrabler.framework.util.Painter;
import com.toymoon.snoblervsgrabler.game.state.LoadState;
import com.toymoon.snoblervsgrabler.game.state.State;
...
public class GameView extends SurfaceView implements Runnable{
	...
	public void setCurrentState(State newState){
		System.gc();
		newState.init();
		//newState.init(GAME_WIDTH, GAME_HEIGHT);
